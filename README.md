...
- 1부터 9까지 서로 다른 수로 이루어진 3자리의 수 랜덤 생성
- 게임 시작 문구 출력
- 1부터 9까지 서로 다른 수로 이루어진 3자리의 수 입력받기
- 3자리의 수를 입력받은 것에 대해 사용자가 잘못된 값을 입력하지 않는지 검사
- 생성된 숫자와 입력받은 숫자 비교
- 비교한 결과 출력
- 3개의 숫자를 모두 맞히면 게임 종료하기
- 재시작/종료를 구분하는 1과 2 중 하나의 수 입력받기
- 1, 2를 입력받은 것에 대해 사용자가 잘못된 값을 입력하지 않는지 검사
- 1을 입력받으면 게임 재시작하기
- 2를 입력받으면 게임 완전히 종료하기
